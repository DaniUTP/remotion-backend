...
;// ./src/start/Autocheck.tsx





const { fontFamily: FONT_POPPINS } = loadFont("normal", {
  weights: ["900"]
});
const FONT_STACK = `${FONT_POPPINS}, Impact, Arial Black, sans-serif`;
const TEXT_STYLE = {
...
const COUNTDOWN_STYLE = {
  ...
  color: "#FFCC00",
  // Vibrant Yellow
  WebkitTextStroke: "20px #131A2B",
  // Thinner dark outline
  paintOrder: "stroke fill",
  // Ensures stroke stays outside the fill
  paddingTop: 60
};
const AnimatedPart = ({ children, delay, style }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const spr = (0,esm.spring)({
    frame: frame - delay,
    fps,
    config: { damping: 12 }
  });
  return /* @__PURE__ */ (0,jsx_runtime.jsx)("span", { style: {
    ...
    opacity: (0,esm.interpolate)(spr, [0, 1], [0, 1]),
    transform: `translateY(${(0,esm.interpolate)(spr, [0, 1], [20, 0])}px)`
  }, children });
};
const Contador = ({ countdownTexts }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const startFrame = 60;
  ...
  const step = Math.floor(localFrame / framesPerStep);
  let display = "";
  if (step === 0) display = countdownTexts[0] || "3";
  else if (step === 1) display = countdownTexts[1] || "2";
  else if (step === 2) display = countdownTexts[2] || "1";
  else if (step >= 3) display = countdownTexts[3] || "GO!";
  const progress = (0,esm.spring)({
    frame: localFrame % 15,
    fps,
    config: { damping: 12, stiffness: 200 }
  });
  const scale = (0,esm.interpolate)(progress, [0, 1], [0.5, 1.2]);
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(
    "div",
    {
      style: {
        ...COUNTDOWN_STYLE,
        fontSize: display === "GO!" ? 220 : 160,
        // Increased size for numbers
...
const Autocheck = ({ introData }) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const showHeader = frame >= 0;
  const showListo = frame >= 45;
  const showContador = frame >= 60;
  const titleEntrance = (0,esm.spring)({
    frame,
    fps,
    config: { damping: 14, mass: 1 }
  });
  const titleTranslateY = (0,esm.interpolate)(titleEntrance, [0, 1], [600, 0]);
  const titleOpacity = (0,esm.interpolate)(titleEntrance, [0, 0.5], [0, 1]);
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { style: { fontFamily: FONT_STACK }, children: [
    introData.backgroundImage && /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Img,
      {
    ...
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.AbsoluteFill, { style: { backgroundColor: "rgba(0,0,0,0.2)" } }),
      ...
      esm.AbsoluteFill,
      {
        ...
        children: [
          /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
            ...
            // Keeping layout container behavior
            display: "flex",
            justifyContent: "center",
            width: "100%"
          }, children: showHeader && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: TEXT_STYLE, children: introData.title.split(" ").map((word, index) => /* @__PURE__ */ (0,jsx_runtime.jsxs)(react.Fragment, { children: [
            /* @__PURE__ */ (0,jsx_runtime.jsx)(AnimatedPart, { delay: index * 12, children: word }),
            index < introData.title.split(" ").length - 1 && " "
          ] }, index)) }) }),
          showListo && /* @__PURE__ */ (0,jsx_runtime.jsx)(
            "div",
            {
              style: {
                ...TEXT_STYLE,
              ...
              children: /* @__PURE__ */ (0,jsx_runtime.jsx)(AnimatedPart, { delay: 45, children: introData.readyText })
            }
          ),
          showContador && /* @__PURE__ */ (0,jsx_runtime.jsx)(Contador, { countdownTexts: introData.countdownTexts })
        ]
      }
    ),
    introData.audioUrl && /* @__PURE__ */ (0,jsx_runtime.jsx)(
      esm.Audio,
      {
        src: introData.audioUrl
      }
    )
  ] });
};
...
const COLORS = {
  background: "#161f53ff",
  // Deep Navy Blue
  accent: "rgb(229, 179, 0)",
  // User provided gold
  white: "#FFFFFF",
  text: "#4c3838ff",
  correct: "#7ed957",
  timerText: "#FFFFFF",
  timerStrokeDefault: "#161f53ff",
  timerStrokeUrgent: "#E53935"
  // Softer Red, not Neon
};
...
const Opcion = ({
  ...
  const frame = (0,esm.useCurrentFrame)();
  const delay = index * 4;
  const entranceFrame = frame - delay - 20;
  const progress = (0,esm.spring)({
    frame: entranceFrame,
    fps,
    config: { damping: 20 }
  });
  const esCorrecta = correcta && mostrarCorrecta;
  const innerColor = esCorrecta ? COLORS.correct : COLORS.white;
  const containerColor = COLORS.accent;
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    "div",
    {
      style: {
        ...
        opacity: (0,esm.interpolate)(entranceFrame, [0, 15], [0, 1], { extrapolateRight: "clamp" }),
...
const Pregunta = ({
  ...
  const remainingSeconds = Math.max(0, Math.ceil((durationFrames - frame) / fps));
  const mostrarCorrecta = remainingSeconds === 0;
  const isUrgent = remainingSeconds <= 5;
  const timerStrokeColor = isUrgent ? COLORS.timerStrokeUrgent : COLORS.timerStrokeDefault;
  const timerStrokeWidth = "3px";
  const cardEntrance = (0,esm.spring)({
    frame,
    fps,
    ...
    esm.AbsoluteFill,
    {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsxs)(
          "div",
          {
            ...
            children: [
                  ...
                  children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
                    "div",
                    {
                      style: {
                        ...
                        fontFamily: FONT_FAMILY,
                        marginTop: 10,
                        WebkitTextStroke: `${timerStrokeWidth} ${timerStrokeColor}`,
                        textShadow: "none"
                      },
              ...
              imagen && /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "div",
                {
                  style: {
                    padding: 10,
              ...
              /* @__PURE__ */ (0,jsx_runtime.jsx)(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
                    esm.Img,
                    {
                      src: "https://www.autocheckapp.pe/assets/images/logo/logo.png",
                      style: {
                        width: "90%",
                        height: "90%",
                        objectFit: "contain"
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
          ...
          flexDirection: "column",
          marginTop: 20
        }, children: opciones.map((op, i) => /* @__PURE__ */ (0,jsx_runtime.jsx)(
          Opcion,
          {
            index: i,
            texto: op,
        ...
        /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: durationFrames, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Audio, { src: tickAudioUrl }) }),
        /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: durationFrames, durationInFrames: fps * 3, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Audio, { src: correctAudioUrl }) }),
        narrationUrl && /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Audio, { src: narrationUrl }),
        answerNarrationUrl && /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: durationFrames, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Audio, { src: answerNarrationUrl }) })
      ]
    }
  );
};
const BebitoFinal = ({
  ...
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const textSpring = (0,esm.spring)({
    frame,
    fps,
    config: { damping: 12, mass: 0.8 }
  });
  const imageSpring = (0,esm.spring)({
    frame: frame - 10,
    fps,
    config: { damping: 10, mass: 0.9 }
  });
  const opacity = (0,esm.interpolate)(frame, [0, 10], [0, 1], { extrapolateRight: "clamp" });
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    esm.AbsoluteFill,
    {
      style: {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
          ...
          data.title && /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: {
            fontSize: 105,
            marginBottom: 30
          }, children: data.title }),
          /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { style: { lineHeight: 1.3, fontSize: 110 }, children: data.text })
        ] }),
        data.image && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          esm.Img,
          {
            src: data.image,
            style: {
              ...
              bottom: 0,
              left: "53%",
              transform: `translateX(-50%) scale(${imageSpring}) translateY(${(0,esm.interpolate)(imageSpring, [0, 1], [150, 0])}px)`,
              objectFit: "contain"
            }
          }
        ),
        data.audioUrl && /* @__PURE__ */ (0,jsx_runtime.jsx)(
          esm.Audio,
          {
            src: data.audioUrl
          }
...
const FinalMarketing = ({
  data
}) => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const pulseTrigger = frame - 30;
  const pulse = (0,esm.spring)({
    frame: pulseTrigger,
    fps,
    config: { damping: 10, mass: 0.5, stiffness: 100 }
  });
  const scale = (0,esm.interpolate)(pulse, [0, 0.5, 1], [1, 1.2, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp"
  });
  const glowOpacity = (0,esm.interpolate)(scale, [1, 1.2], [0, 0.8]);
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(
    esm.AbsoluteFill,
    {
      style: {
      ...
      children: [
        /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: {
          ...
          data.logo && /* @__PURE__ */ (0,jsx_runtime.jsx)(
            esm.Img,
            {
              src: data.logo,
              style: {
...
const Quiz = ({ config, questions, midFinal, finalVideo }) => {
  const { fps } = (0,esm.useVideoConfig)();
  let currentStartFrame = 0;
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { children: [
    questions.map((q, i) => {
      const countdownFrames = q.countdownSeconds * fps;
      const revealFrames = q.revealSeconds * fps;
      const totalFrames = countdownFrames + revealFrames;
      const seq = /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: currentStartFrame, durationInFrames: totalFrames, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
        Pregunta,
        {
          imagen: q.image,
          pregunta: q.question,
          correctaIndex: q.correctIndex,
          durationSeconds: q.countdownSeconds,
          opciones: q.options,
          narrationUrl: q.narrationUrl,
          answerNarrationUrl: q.explanationAudioUrl,
          tickAudioUrl: config.tickAudioUrl,
          correctAudioUrl: config.correctAudioUrl
        }
      ) }, i);
      currentStartFrame += totalFrames;
      return seq;
    }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: currentStartFrame, durationInFrames: midFinal.durationSeconds * fps, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(BebitoFinal, { data: midFinal }) }),
    (() => {
      currentStartFrame += midFinal.durationSeconds * fps;
      return null;
    })(),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: currentStartFrame, durationInFrames: finalVideo.durationSeconds * fps, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(FinalMarketing, { data: finalVideo }) })
  ] });
};
...
const MainVideo = ({ config, intro, questions, midFinal, finalVideo }) => {
  const { fps } = (0,esm.useVideoConfig)();
  const introDurationFrames = intro.durationSeconds * fps;
  const questionsDurationFrames = questions.reduce((acc, q) => {
    return acc + (q.countdownSeconds + q.revealSeconds) * fps;
  }, 0);
  const midFinalDurationFrames = midFinal.durationSeconds * fps;
  const finalVideoDurationFrames = finalVideo.durationSeconds * fps;
  const quizTotalDurationFrames = questionsDurationFrames + midFinalDurationFrames + finalVideoDurationFrames;
  const musicStartFrame = 90;
  const musicEndFrame = introDurationFrames + questionsDurationFrames + midFinalDurationFrames;
  const musicDurationFrames = Math.max(0, musicEndFrame - musicStartFrame);
  const audioClipDurationSecs = config.backgroundMusicDurationSeconds || 3;
  const audioClipDurationFrames = Math.floor(audioClipDurationSecs * fps);
  const CROSSFADE_SECS = 0.5;
  const crossfadeFrames = Math.floor(CROSSFADE_SECS * fps);
  const loopPeriodFrames = audioClipDurationFrames - crossfadeFrames;
  const numberOfLoops = Math.ceil(musicDurationFrames / loopPeriodFrames) + 1;
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(esm.AbsoluteFill, { children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: 0, durationInFrames: introDurationFrames, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Autocheck, { introData: intro }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: introDurationFrames, durationInFrames: quizTotalDurationFrames, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
      Quiz,
      {
        config,
        questions,
    ...
    musicDurationFrames > 0 && /* @__PURE__ */ (0,jsx_runtime.jsx)(esm.Sequence, { from: musicStartFrame, durationInFrames: musicDurationFrames, children: new Array(numberOfLoops).fill(0).map((_, i) => {
      const startFrame = i * loopPeriodFrames;
      if (startFrame >= musicDurationFrames) return null;
      return /* @__PURE__ */ (0,jsx_runtime.jsx)(
        esm.Sequence,
        {
          from: startFrame,
          durationInFrames: audioClipDurationFrames,
          layout: "none",
          children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
            esm.Audio,
            {
              ...
              volume: (f) => {
                const fadeIn = (0,esm.interpolate)(f, [0, crossfadeFrames], [0, 1], {
                  extrapolateLeft: "clamp",
                  extrapolateRight: "clamp"
                });
                const fadeOut = (0,esm.interpolate)(
                  f,
                  [audioClipDurationFrames - crossfadeFrames, audioClipDurationFrames],
                  [1, 0],
                  { extrapolateLeft: "clamp", extrapolateRight: "clamp" }
                );
                return fadeIn * fadeOut * config.backgroundMusicVolume;
              }
            }
          )
        },
...
const isValidVideoData = (data) => {
  return data && typeof data === "object" && data.config && data.intro && data.questions && data.midFinal && data.finalVideo;
};
const RemotionRoot = () => {
  const fps = 30;
  const calculateDuration = (data) => {
    const introDuration = data.intro.durationSeconds * fps;
    const questionsDuration = data.questions.reduce((acc, q) => {
      return acc + (q.countdownSeconds + q.revealSeconds) * fps;
    }, 0);
    const midFinalDuration = data.midFinal.durationSeconds * fps;
    const finalVideoDuration = data.finalVideo.durationSeconds * fps;
    return Math.ceil(introDuration + questionsDuration + midFinalDuration + finalVideoDuration);
  };
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, { children: /* @__PURE__ */ (0,jsx_runtime.jsx)(
    esm.Composition,
    {
      ...
      calculateMetadata: ({ props }) => {
        if (!isValidVideoData(props)) {
          console.warn("Invalid video data, using default values");
          return {
            durationInFrames: 1,
            fps,
            width: 1080,
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    Promise.all(/* import() */[__webpack_require__.e(618), __webpack_require__.e(845)]).then(__webpack_require__.bind(__webpack_require__, 9618)).then(({ StudioInternals }) => {
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "Aprendiendo remotion:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkAprendiendo_remotion"] = self["webpackChunkAprendiendo_remotion"] || [];
